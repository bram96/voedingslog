...
WS_GET_SUGGESTIONS = f"{DOMAIN}/get_suggestions"
WS_DAILY_REVIEW = f"{DOMAIN}/daily_review"
WS_GET_RECENT = f"{DOMAIN}/get_recent"
WS_GET_STREAK = f"{DOMAIN}/get_streak"
WS_GET_PERIOD = f"{DOMAIN}/get_period"
WS_MERGE_PRODUCTS = f"{DOMAIN}/merge_products"
WS_REFRESH_PRODUCT = f"{DOMAIN}/refresh_product"
...
WS_AI_GUESS_NUTRIENTS = f"{DOMAIN}/ai_guess_nutrients"
