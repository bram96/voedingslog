...
export const panelStyles = css`
  ...
  .nutrient-toggle { cursor: pointer; padding: 2px 8px; border-radius: 10px; background: var(--secondary-background-color); transition: background 0.15s; user-select: none; -webkit-tap-highlight-color: transparent; }
  ...
  .portion-edit-row { display: flex; align-items: center; gap: 8px; margin-bottom: 8px; }
  .portion-label-input { flex: 3; min-width: 0; padding: 10px 12px; border: 1px solid var(--divider-color); border-radius: 8px; font-size: 14px; background: var(--primary-background-color); color: var(--primary-text-color); }
  .portion-grams-input { flex: 1; min-width: 60px; max-width: 80px; padding: 10px 12px; border: 1px solid var(--divider-color); border-radius: 8px; font-size: 14px; text-align: right; background: var(--primary-background-color); color: var(--primary-text-color); }
